      ...
      function ($stateProvider,   $urlRouterProvider, JQ_CONFIG) {
          ...
          $stateProvider
              ...
              .state('music', {
                ...
                .state('choferes', {
                    url: '/choferes',
                    templateUrl: 'tpl/JIF_tpl/tpl_choferes.html',
                    controller:"ChoferesCtrl",
                    resolve: {
                      deps: ['uiLoad',
                        function( uiLoad ){
                          return uiLoad.load( ['js/controllers/jif_controllers/choferes.js','css/choferModalContent.css',
                            'js/controllers/jif_controllers/modalChoferCtrl.js','js/controllers/jif_controllers/actualizaModalChoferCtrl.js'] );
                      }]
                  }
                })
                 ...
                 .state('molinos', {
                    url: '/molinos',
                    templateUrl: 'tpl/JIF_tpl/tpl_molinos.html',
                    controller:"molinosCtrl",
                    resolve: {
                      deps: ['uiLoad',
                        function( uiLoad ){
                          return uiLoad.load( ['js/controllers/jif_controllers/molinos.js','css/molinoModalContent.css',
                            'js/controllers/jif_controllers/actualizaModalMolinoCtrl.js',
                            'js/controllers/jif_controllers/modalMolinoCtrl.js'] );
                      }]
                  }
                })
      }
